...
export const SettingsSkeleton = () => {
  ...
  const TileSkeleton = () => (
    <View className="p-6 rounded-3xl mb-6 border border-outline-variant/10 bg-surface-container-lowest h-32 flex-row items-center">
      <Skeleton width={48} height={48} borderRadius={16} variant="primary-container" className="mr-4" />
  ...
  return (
    ...
    >
      ...
      <Skeleton width="100%" height={56} borderRadius={16} variant="primary-container" />
    </ScrollView>
  );
};
